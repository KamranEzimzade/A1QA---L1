...
public class Task2_1_Test {
        ...
        void gameSearch() throws InterruptedException {
                ...
                // String nameOfTheGameFromJenkins = System.getProperty("name");

                String nameOfTheGame = mainPage.searchGame("Dota 2");
                ...
                Assert.assertEquals(mainPage.getPlatforms(),
                                mainPage.retrieveGameInfo().get("Platforms"),
                                "The platform name on the web page should be equal to the ones stored in the json file for the first game");
                ...
                Assert.assertEquals(mainPage.getPlatforms(),
                                mainPage.retrieveGameInfo().get("Platforms"),
                                "The platform name on the web page should be equal to the ones stored in the json file for the second game");
                Assert.assertEquals(mainPage.getPrice(), mainPage.retrieveGameInfo().get("Price"),
